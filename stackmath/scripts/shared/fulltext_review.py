...
def main():
    ...
    parser = argparse.ArgumentParser(description="Re-check kept StackMath questions against the archived discussion.")
    ...
    prompt_path = args.prompt or (
        ...
        if args.false
        else "stackmath/prompts/stackexchange/fulltext_review.md"
    )
