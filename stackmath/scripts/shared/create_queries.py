...
ARXIV_FULLTEXT_PROMPT = "stackmath/prompts/stackexchange/fulltext_query.md"
...
def main():
    ...
    parser.add_argument("--paper-root", default="stackmath/paper", help="Root directory containing Stack Exchange thread folders.")
    ...
    mode_group.add_argument(
        "--fulltext",
        action="store_true",
        help="Generate questions from each thread's local full_text.md.",
    )
    ...
    print(f"Kept {len(kept_ids)} threads: {', '.join(kept_ids)}")
